...
// 6 on met dans la variable $mysqli notre connexion à une DB MySQL
$mysqli = @mysqli_connect(DB_HOST,DB_LOGIN,DB_PWD,DB_NAME,DB_PORT);

// 7 on vérifie si la connexion a échoué (existance d'une erreur mysqli_connect)
if(mysqli_connect_error($mysqli)){
    // 8 Arrêt du script avec affichage de l'erreur
    die("Numéro d'erreur: ".mysqli_connect_errno($mysqli)."<br>Affichage de l'erreur: ".utf8_encode(mysqli_connect_error($mysqli)));
}

// 9 encodage des communications entre la db et php (choix de l'utf8)
